...
async def main():
    while True:
        ...
        try:
            ...
            print(f"🔌 Attempting to connect to Heltec on {SERIAL_PORT}...")
            ...
            print(f"✅ Successfully connected on {SERIAL_PORT}")
            ...
            if not room_contact:
                logger.error("Room contact not found!")
                print("❌ Room contact not found!")
            ...
            # Keep running until disconnect/crash
            await asyncio.sleep(float('inf'))
            ...
            logger.info("Waiting 5 seconds before reconnect attempt...")
